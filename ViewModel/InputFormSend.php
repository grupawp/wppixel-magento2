 ...
 */
class InputFormSend extends AbstractTrack
{
    /**
    ...
    {
        $isSent = $this->isFormSentSuccessfully();
        $this->dataPersistor->clear('contact_us_sent');

        return $isSent && $this->configHelper->isContactFormTrackingEnabled();
    }
